...
DACBD/BACDA/ABDDB/ACCBC/BCADA/BCCBC/ABABD/CDADD/FCGBA
...
There are many understandable reasons why you might find it difficult to ask for help when you need it. Psychologists have been interested in this **question** for decades, not least because people’s widespread **~~tendency~~ reluctance** to ask for help has led to some high-profile failures.

Asking for help takes **courage**. It involves communicating a need on your part — there’s something you can’t do. **In other words**, you’re broadcasting your own weakness, which can be **uncomfortable** . You might have **concerns** about losing control of whatever it is you are asking for help with. **Once** someone starts to help, perhaps they will take over, or get a credit for your early efforts. Yet another **factor** that you might be worried about is being a nuisance or **inconveniencing** the person you go to for help.

If you struggle with low self-esteem, you might find it especially difficult to **reach out** for help because you have the added worry of the other person **declining** your request. You might see such refusals as implying something **negative** about the status of your relationship with them. To **overcome** these difficulties, try to remind yourself that everyone needs help sometimes. Nobody knows everything and can do everything all by themselves. And while you might **~~missing~~ fear** coming across as incompetent, there’s actually research that shows that adviceseekers are **~~disguished~~ perceived** as more competent, not less.

Perhaps most encouraging of all is a paper from 2022 by researchers at Stanford University, in California, that involved a mix of contrived help-seeking interactions and asking people to **recall** times they’d sought help in the past. The findings showed that help-seekers generally underestimate how **willing** other people will be to help and how good it will make the help-giver feel (for most people, having the chance to help someone is highly **~~surprising~~ rewarding** ).

So bear all this in mind the next time you need to ask for help. **Also** , take care over who you ask and when you ask them. And if someone can’t help right now, avoid taking it personally. They might just be too **busy** , or they might not feel confident about their ability to help.

**DACBD/BACDA/ABDDB/ACCBC**
...
21. According to Paragraph 1, the practice of tipping in the U.S.
    ~~**A. was regarded as a sign of generosity.**~~ **（正解：B）**
    B. was considered essential for waiters.
    C. was a way of rewarding diligence.
    D. was optional in most businesses.

> [!danger]- 第21题解析
> 第一段指出美国人传统上给那些"主要靠小费为生的人"付小费（如收入低于最低工资的餐厅服务员），说明小费对这些服务人员是必要的收入来源（B项），而非"慷慨的象征"（A项）。
...
23. Tip requests are creeping into new kinds of services as a result of _
...
24. The movement toward no-tipping services was intended to _
    A. promote consumption.
    B. enrich income sources.
    C. maintain reasonable prices.
    **D. guarantee income fairness.**

25. It can be learned from the last paragraph that tipping ___
...
When it was established, the National Health Service (NHS) was visionary: offering highquality, timely care to meet the dominant needs of the population it served. Nearly 75 years on, with the UK facing very different health challenges, it is clear that the model is out of date.
...
26. According to the first two paragraphs, the NHS
    ~~**A. is troubled by funding deficiencies.**~~ **（正解：B）**
    B. can hardly satisfy people’s needs.
    C. can barely retain its current employees.
    D. is rivalled by private medical services.

> [!danger]- 第26题解析
> 前两段指出NHS模式已过时，英国在寿命、癌症、婴儿死亡率等方面落后于同类国家，680万人在等候名单上，医疗越来越难以获得。核心问题是NHS无法满足人们的需求（B项），文中未提及资金不足（A项）。
...
28. “Reimagining health” is aimed to
    ...
    ~~**B. readjust healthcare regulations.**~~ **（正解：C）**
    C. restructure the health system.
    D. resume suspended health reforms.

> [!danger]- 第28题解析
> 文中说Reform智库发起”Reimagining health”项目，呼吁对”以医院为中心的模式进行紧急反思”（urgent rethink of the hospital-centric model）。这是对整个医疗体系的重构（C项），而非调整法规这种局部调整（B项）。
...
> [!danger]- 第30题解析
> 末段指出地方领导"often responsible for services that create health, and with a much better understanding of the needs of their populations"。他们对民众需求已有更深理解（D项是已述事实，非推断），因此推断他们应在医疗体系中发挥更大作用（C项）。
...
To help improve HAPs, urban planner Kotharkar’s team is working on a model plan that outlines best practices and could be adapted to local conditions. ==Among other things, she says, all cities should create a vulnerability map to help focus responses on the populations most at risk. Such mapping doesn’t need to be complex, Kotharkar says. “A useful map can be created by looking at even a few key parameters.” For example, neighborhoods with a large elderly population or informal dwellings that cope poorly with heat could get special warnings or be bolstered with cooling centers. The Nagpur project has already created a risk and vulnerability map, which enabled Kotharkar to tell officials which neighborhoods to focus on in the event of a heat wave this summer.==
...
34. Kotharkar holds that a vulnerability map can help __
...
38. The images on the Reddit webpage reflect _
    **A. conflicting opinions on the use of desire paths.**
    B. the call to upgrade the designing of public spaces.
    ~~**C. the demand for proper planning of desire paths.**~~ **（正解：A）**
    D. growing concerns over the loss of public spaces.

> [!danger]- 第38题解析
> Reddit页面上desire paths旁有"请走指定人行道"的标识，这"突显了自发演变与视觉规划之间的持续斗争"（ongoing struggle between organic evolution and controlled urban environment），反映的是两种观点的冲突（A项），而非要求合理规划（C项）。
...
40. It can be learned from the last paragraph that desire paths _
...
A. Stay positive B. Respect the past C. Use channels D. Give it time E. Invite resistance F. Be a salesman G. Be humble
...
[https://zhenti.burningvocabulary.cn](https://zhenti.burningvocabulary.cn/)
...
[https://cdn-mineru.openxlab.org.cn/result/2026-07-20/3c38f199-0ee2-4ec5-8ff3-e3b9e95bbbb6/a3d08bc79d121cdb46568a1a748b692d1235e08af96802906041726a2aaaa234.jpg](https://cdn-mineru.openxlab.org.cn/result/2026-07-20/3c38f199-0ee2-4ec5-8ff3-e3b9e95bbbb6/a3d08bc79d121cdb46568a1a748b692d1235e08af96802906041726a2aaaa234.jpg)
