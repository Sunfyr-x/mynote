...
Weighing yourself regularly is a wonderful way to stay aware of any significant weight fluctuations. **1.However**, when done too often, this habit can sometimes hurt more than it **2.helps**.

As for me, weighing myself every day caused me to shift my focus from being generally healthy and physically active to focusing **3.solely** on the scale. That was bad to my overall fitness goals. I had gained weight in the form of muscle mass, but thinking only of **4.lowering** the number on the scale, I altered my training program. That conflicted with how I needed to train to **5.reach** my goals.

I also found that weighing myself daily did not provide an accurate **6.depiction** of the hard work and progress I was making in the gym. It takes about three weeks to a month to notice any significant changes in your weight **7.due to** altering your training program. The most **8.immediate** changes will be observed in skill level, strength and inches lost.

For these **9.reasons**, I stopped weighing myself every day and switched to a bimonthly weighing schedule **10.instead**. Since weight loss is not my goal, it is less important for me to **11.track** my weight each week. Weighing every other week allows me to observe and **12.account for** any significant weight changes. That tells me whether I need to **13.adjust** my training program.

I use my bimonthly weigh-in **14.results** to get information about my nutrition as well. If my training intensity remains the same, but I'm constantly **15.hungry** and dropping weight, this is a **16.sign** that I need to increase my daily caloric intake.

The **17.decision** to stop weighing myself every day has done wonders for my overall health, fitness and well-being. I'm experiencing increased zeal for working out since I no longer carry the burden of a **18.disappointing** morning weigh-in. I've also experienced greater success in achieving my specific fitness goals, **19.because** I'm training according to those goals, not the numbers on a scale.

Rather than **20.obsessing** over the scale, turn your focus to how you look, feel, how your clothes fit and your overall energy level.

| 题号  | A             | B             | C           | D          |
| --- | ------------- | ------------- | ----------- | ---------- |
| 1   | However       | Therefore     | Otherwise   | Besides    |
| 2   | cares         | helps         | warns       | reduces    |
| 3   | initially     | occasionally  | solely      | formally   |
| 4   | recording     | explaining    | lowering    | accepting  |
| 5   | reach         | set           | review      | modify     |
| 6   | definition    | distribution  | depiction   | prediction |
| 7   | regardless of | due to        | aside from  | along with |
| 8   | immediate     | rigid         | precise     | orderly    |
| 9   | claims        | judgments     | methods     | reasons    |
| 10  | though        | instead       | again       | indeed     |
| 11  | report        | overlook      | track       | conceal    |
| 12  | account for   | approve of    | hold onto   | depend on  |
| 13  | prepare       | share         | confirm     | adjust     |
| 14  | features      | results       | rules       | tests      |
| 15  | bored         | anxious       | sick        | hungry     |
| 16  | sign          | secret        | belief      | principle  |
| 17  | request       | necessity     | wish        | decision   |
| 18  | surprising    | disappointing | restricting | consuming  |
| 19  | if            | unless        | because     | until      |
| 20  | dominating    | obsessing     | puzzling    | triumphing |
...
**25. The word "transgressions" (Paragraph 5) is closest in meaning to**  
    - A. teachings  
    - B. discussions  
    - C. wrongdoings  
    - D. restrictions  
...
| 人名 | 匹配信息 |
|------|----------|
| 41. Ryan Hooper | B. remarks that significant moves may pose challenges to children |
| 42. Adam Bailey | E. thinks that children should be given a sense of involvement in homebuying decisions |
| 43. Tracey Hampson | D. advises that home purchases should not be based only on children's opinions |
| 44. Aaron Norris | A. assumes that many children's views on real estate are influenced by the media |
| 45. Julie Gurner | G. believes that homebuying decisions should be based on children's needs rather than their opinions |

**多余选项：**  
- C. says that it is wise to leave kids in the dark about real estate decisions  
- F. notes that aspects like children's friends and social activities should be considered upon homebuying  
...
> （注：原试卷此处附有一张图表，内容为某年份某高校学生使用不同交通方式的比例，因无法提取图像数据，请参考原 PDF 第 14 页图表作答。）