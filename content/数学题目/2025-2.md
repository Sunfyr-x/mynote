...
### 1
[[第13讲：多元函数微分学#隐函数存在定理（公式法）|隐函数存在定理]]
...
### 3
[[第15讲：微分方程#高数30讲.pdf page=393&selection=48,1,48,13 二阶常系数齐次线性微分方程|二阶常系数齐次线性微分方程]]
...
>==即使是复数根，也符合上列两个等式，我们的目的是让所有特征根的实部为负==
> 故 $-2 < a < 0$.

### 4
[[第1讲：函数极限与连续#高数30讲.pdf page=48&selection=4,0,4,1 无穷小的比阶|无穷小的比阶]]
...
[[5-特征值和特征向量#线代30讲.pdf page=146&selection=20,1,20,15 矩阵的特征值与特征向量的求法]]
...
[[4-线性方程组#线代30讲.pdf page=134&selection=4,2,5,1 两个方程组的公共解|公共解]]
==举例法更好，最好一个0一个1方便构造==
