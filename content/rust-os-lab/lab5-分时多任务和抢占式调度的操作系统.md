...
![](file-2026-06-08-15--06-48.png)

接着，在sbi子模块实现设置mtimecmp的值，并在timer子模块进行封装

![](file-2026-06-08-15--06-35.png)

![](file-2026-06-08-15--06-51.png)

同时，为了后续的计时操作，还需要在timer子模块封装另外一个函数，实现以毫秒为单位返回当前计数器的值。

![](file-2026-06-08-15--06-28.png)
...
![](file-2026-06-08-15--06-04%201.png)

### 实现新的测试应用

分别实现00power_3.rs，01power_5.rs，02power_7.rs以及03sleep.rs四个测试应用程序

![](file-2026-06-08-15--06-08.png)

![](file-2026-06-08-15--06-10%201.png)

![](file-2026-06-08-15--06-15.png)

![](file-2026-06-08-15--06-17.png)

## 抢占式调度 
	
完成时钟中断和计时器后，就很容易实现抢占式调度了。具体修改os/src/trap/mod.rs代码，具体如下：

![](file-2026-06-08-15--06-56.png)

这里通过调用suspend_current_and_run_next实现应用的切换。注意这里部分代码是修改，并不是直接新增。

另外，我们还需要在第一个应用执行之前在main.rs中做一些初始化的工作。具体增加如下代码：

![](file-2026-06-08-15--06-24.png)

至此，支持分时多任务和抢占式调度的操作系统实现完成。

运行截图如下

![](file-2026-06-08-15--06-75%201.png)

![](file-2026-06-08-15--06-76.png)
## 思考和回答问题
### （1）分时多任务的实现分析
